...
// status é forçado para ACTIVE pelo service quando o chamador não é STAFF nem
// professor de nenhuma turma (visibilidade — ver EbdService.searchClasses).
...
public record EbdClassQuery(
    ...
    public static final class Builder {
        ...
        public Builder fixed(Boolean v) { this.fixed = v; return this; }
        ...
        public EbdClassQuery build() {
            return new EbdClassQuery(id, name, fixed, cycleId, status, pagination);
        }
    }
}
